...
(define-key boon-command-map (kbd "C-M-j") 'shrink-window-horizontally-5)
(define-key boon-command-map (kbd "C-M-l") 'enlarge-window-horizontally-5)
(define-key boon-command-map (kbd "C-M-k") 'shrink-window-3)
(define-key boon-command-map (kbd "C-M-i") 'enlarge-window-3)
...
(define-key boon-special-map (kbd "C-M-j") 'shrink-window-horizontally-5)
(define-key boon-special-map (kbd "C-M-l") 'enlarge-window-horizontally-5)
(define-key boon-special-map (kbd "C-M-k") 'shrink-window-3)
(define-key boon-special-map (kbd "C-M-i") 'enlarge-window-3)
