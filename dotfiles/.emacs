...
(custom-set-faces
 ...
 '(diff-added ((t (:background "#d7eadd" :foreground "#4e662c"))))
 '(diff-changed ((t (:background "#eeeebb" :foreground "#aaaa11"))))
 '(diff-refine-added ((t (:inherit diff-added :background "#aaffaa"))))
 '(diff-refine-changed ((t (:inherit diff-changed :background "#eeee99"))))
 '(diff-refine-removed ((t (:inherit diff-removed :background "#ffbbbb"))))
 '(diff-removed ((t (:background "#f5dee6" :foreground "#9e4161"))))
 ...
 '(font-lock-variable-name-face ((t (:foreground "#468a75"))))
