...
(custom-set-faces
 ...
 '(diff-added ((t (:inherit (font-lock-function-name-face diff-added-bg)))))
 ...
 '(diff-removed ((t (:inherit (diff-removed-bg font-lock-type-face) :underline nil))))
 '(diff-removed-bg ((t (:background "#EFE0F0"))))
 '(diff-removed-fine-bg ((t (:background "#EBD3E4"))))
 '(dired-marked ((t (:inherit font-lock-variable-name-face :weight bold))))
 ...
 '(font-lock-constant-face ((t (:foreground "#897FBD"))))
 ...
 '(magit-diff-removed ((t (:inherit (diff-removed-bg font-lock-type-face) :foreground "#CF93DB"))))
 ...
 '(trailing-whitespace ((t (:background "PaleVioletRed2"))))
