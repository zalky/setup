...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#e7e7e7" :foreground "#707070" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 130 :width normal :foundry "nil" :family "Fira Mono"))))
 ...
 '(diff-added ((t (:inherit (font-lock-type-face diff-added-bg)))))
 '(diff-added-bg ((t (:background "#E8F2EB"))))
 '(diff-added-fine-bg ((t (:background "#CBE9D9"))))
 ...
 '(diff-removed ((t (:inherit (diff-removed-bg font-lock-function-name-face) :underline nil))))
 '(diff-removed-bg ((t (:background "#EFE0F0"))))
 '(diff-removed-fine-bg ((t (:background "#EBD3E4"))))
 ...
 '(font-lock-comment-face ((t (:foreground "gray65" :slant italic))))
 '(font-lock-constant-face ((t (:foreground "#24BCB3"))))
 '(font-lock-doc-face ((t (:inherit font-lock-comment-face))))
 '(font-lock-function-name-face ((t (:foreground "#C97FDB"))))
 '(font-lock-keyword-face ((t (:foreground "grey45" :weight bold))))
 '(font-lock-string-face ((t (:foreground "#6DBCA9"))))
 '(font-lock-type-face ((t (:foreground "#00ADD7"))))
 '(font-lock-variable-name-face ((t (:foreground "#978CD2"))))
 '(fringe ((t (:inherit (font-lock-comment-face default) :slant normal))))
 '(git-commit-summary ((t (:inherit font-lock-string-face))))
 '(header-line ((t (:background "#e2e2e2" :box nil))))
 ...
 '(helm-selection ((t (:inherit nil :background "#dcdcdc"))))
 '(helm-selection-line ((t nil)))
 '(helm-separator ((t (:inherit font-lock-function-name-face))))
 ...
 '(link ((t (:foreground "orchid" :underline t))))
 ...
 '(magit-diff-added ((t (:inherit (diff-added-bg font-lock-string-face) :foreground "#6DBCA9"))))
 '(magit-diff-added-highlight ((t (:inherit magit-diff-added))))
 '(magit-diff-base ((t (:inherit diff-changed))))
 '(magit-diff-base-highlight ((t (:inherit diff-changed))))
 '(magit-diff-context ((t (:foreground "grey70" :slant normal))))
 ...
 '(magit-diff-removed ((t (:inherit (diff-removed-bg font-lock-function-name-face) :foreground "#CF93DB"))))
 ...
 '(mode-line ((t (:background "#d8d8d8" :foreground "#696969" :box (:line-width 4 :color "#d8d8d8")))))
 '(mode-line-inactive ((t (:inherit mode-line :background "#dcdcdc" :foreground "#959595" :box (:line-width 4 :color "#dcdcdc") :weight light))))
 ...
 '(show-paren-match ((t (:background "#d0d0d0" :foreground "#ebebeb"))))
