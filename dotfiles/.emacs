...
(custom-set-faces
 ...
 '(magit-diff-context-highlight ((t (:inherit region))))
 '(magit-diff-hunk-heading ((t (:inherit header-line))))
 '(magit-diff-hunk-heading-highlight ((t (:inherit header-line))))
 '(magit-header-line ((t (:inherit ##))))
 '(magit-section-heading ((t (:inherit header-line :weight bold))))
 '(magit-section-highlight ((t (:inherit header-line))))
