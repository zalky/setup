...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:inherit nil :stipple nil :background "#c0c0c0" :foreground "#404040" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 130 :width normal :foundry "nil" :family "Fira Mono"))))
 ...
 '(font-lock-builtin-face ((t (:foreground "gray38"))))
 ...
 '(font-lock-keyword-face ((t (:foreground "grey35" :weight bold))))
 ...
 '(fringe ((t (:inherit default :foreground "#777777"))))
