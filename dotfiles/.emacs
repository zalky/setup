...
(custom-set-faces
 ...
 '(diff-added-bg ((t (:background "#E6F0F0"))))
 ...
 '(diff-removed-bg ((t (:background "#EEE6F0"))))
 ...
 '(font-lock-constant-face ((t (:foreground "#698BC4"))))
 '(font-lock-doc-face ((t (:inherit font-lock-comment-face))))
 '(font-lock-function-name-face ((t (:foreground "#00ADD7"))))
 '(font-lock-keyword-face ((t (:foreground "grey45" :weight bold))))
 '(font-lock-string-face ((t (:foreground "#897FBD"))))
 '(font-lock-type-face ((t (:foreground "#AB7ED2"))))
 '(font-lock-variable-name-face ((t (:foreground "#00B0A6"))))
 ...
 '(link ((t (:foreground "orchid2" :underline t))))
